...
static async Task SeedAuth(CrmDbContext db, IAuthService authService, Guid empresaId)
{
    ...
    var caps = new (string Clave, string Nombre, string Modulo, string ModuloClave, string Desc)[]
    {
        ...
        ("turnos.ver", "Ver turnos", "Turnos", ModuloAccesoCatalog.Rrhh, "Acceso a la configuración de turnos"),
        ("turnos.editar", "Editar turnos", "Turnos", ModuloAccesoCatalog.Rrhh, "Crear y editar turnos de trabajo"),
